...
import com.example.aather.service.ComunicationServiceActions.*
import com.example.aather.utils.DataModel
import com.example.aather.utils.DataModelType
import com.example.aather.utils.isValid
...
@AndroidEntryPoint
class ComunicationService : Service(), ComunicationRepository.Listener {
    ...
    private fun startServiceWithNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val intent = Intent(this,ComunicationServiceReceiver::class.java).apply {
                action = "ACTION_EXIT"
            }

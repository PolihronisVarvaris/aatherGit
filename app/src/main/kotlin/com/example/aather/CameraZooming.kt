...
class CameraZooming: AppCompatActivity() {
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
                    ...
                    // Start com.example.aather.SizeZoom activity and pass the photo URI
                    val intent = Intent(this@CameraZooming, Size_image::class.java).apply {
    ...
    private fun saveImageToGallery(imageUri: Uri) {
        ...
        uri?.let {
            Toast.makeText(this@CameraZooming, "Image saved to Gallery", Toast.LENGTH_SHORT).show()
        } ?: run {
            Toast.makeText(this@CameraZooming, "Failed to save image to Gallery", Toast.LENGTH_SHORT).show()
        }
    }

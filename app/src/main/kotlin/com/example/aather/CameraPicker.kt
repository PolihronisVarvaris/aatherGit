...
class CameraPicker: AppCompatActivity() {
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
                    ...
                    // Start com.example.aather.ColorPicker activity and pass the photo URI
                    val intent = Intent(this@CameraPicker, PickColorFilter::class.java).apply {
    ...
    private fun saveImageToGallery(imageUri: Uri) {
        ...
        uri?.let {
            Toast.makeText(this@CameraPicker, "Image saved to Gallery", Toast.LENGTH_SHORT).show()
        } ?: run {
            Toast.makeText(this@CameraPicker, "Failed to save image to Gallery", Toast.LENGTH_SHORT).show()
        }
    }

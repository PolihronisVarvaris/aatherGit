...
import com.example.aather.databinding.ActivityCallBinding
import com.example.aather.service.ComunicationService
import com.example.aather.service.ComunicationServiceRepository
import com.example.aather.utils.convertToHumanTime
import com.example.aather.webrtc.RTCAudioManager
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.*
import javax.inject.Inject

@AndroidEntryPoint
class CallActivity : AppCompatActivity(), ComunicationService.EndCallListener {
    ...
    override fun onStart() {
        ...
        requestScreenCaptureLauncher = registerForActivityResult(ActivityResultContracts
            ...
            if (result.resultCode == Activity.RESULT_OK){
                ...
                ComunicationService.screenPermissionIntent = intent
    ...
    private fun init(){
        ...
        views.apply {
            ...
            ComunicationService.remoteSurfaceView = remoteView
            ComunicationService.localSurfaceView = localView
        ...
        setupScreenCasting()
        ComunicationService.endCallListener = this
    }
    ...
    override fun onDestroy() {
        super.onDestroy()
        ComunicationService.remoteSurfaceView?.release()
        ComunicationService.remoteSurfaceView = null

        ComunicationService.localSurfaceView?.release()
        ComunicationService.localSurfaceView =null
